...
//sections
import Information from "./Sections/MainInformation.vue";
import AboutTeam from "./Sections/MainTeam.vue";
import Featuring from "./Sections/MainFeaturing.vue";
import Newsletter from "./Sections/MainNewsletter.vue";
